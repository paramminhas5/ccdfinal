...
const Why = () => {
  ...
  const headlineX = useTransform(scrollYProgress, [0, 0.5, 1], [-200, 0, 100]);
  const headline2X = useTransform(scrollYProgress, [0, 0.5, 1], [200, 0, -100]);
  ...
  return (
    <section ref={ref} id="why" className="relative bg-electric-blue border-b-4 border-ink overflow-hidden py-24 md:py-32">
      ...
      <div className="container relative z-10">
        ...
        <h2 className="font-display text-5xl md:text-8xl text-cream leading-[0.9] max-w-5xl drop-shadow-[5px_5px_0_hsl(var(--ink))] overflow-hidden">
